...
<div class="card mt-4">
    ...
    <div class="card-header">
        <a name="" id="" class="btn btn-primary" href="/mahasiswa/formulirMhs" role="button"><i class="bi bi-plus-square-dotted"></i> TAMBAH DATA</a>
    ...
    <div class="card-body">
        <table class="table table-striped">
            ...
            <tr>
                ...
                <th scope="col">Manipulasi</th> {{-- penamabahan nama kolom tabel baru untuk mengidentifikasi tombol edit --}}
            </tr>
            </thead>
            <tbody>
            @foreach ($mahasiswa as $no => $m)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="/mahasiswa/deleteMhs/{{ $m -> id }}" class="btn btn-outline-danger" onclick="return confirm('Anda Yakin Menghapus Data?')">
                            <i class="bi bi-trash"></i>
                        </a>
                    </td> {{-- penamabahan tombol baru untuk edit data --}}
                </tr>
            @endforeach
            </tbody>
        </table>
        ...
        <tr>
            <th scope="row">Total Data per Page -> {{$mahasiswa -> count()}}</th> {{-- menghitung total data pada curent page --}}
        </tr>
    </div>   
</div>
@endsection